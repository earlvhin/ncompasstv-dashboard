export class UI_DEALER_BILLING {
    ...
    constructor(index: object, dealer_id: object, dealer_id_alias: object, dealer_name: object, billable_licenses: object, price_per_license: object, new_license_price: object, base_fee: object, billing: object, billing_date: object, autocharge:object ) {
        this.index = index;
