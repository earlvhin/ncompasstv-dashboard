...
export class FeedService extends BaseService {
	...
	create_weather_feed_demo(weather_feed_style: WEATHER_FEED_STYLE_DATA) {
        return this.getRequest(`${this.creators.api_new_weather_feed_demo}` +'?backgroundContentId=' + `${weather_feed_style.bannerContentId}` + '&bannerContentId=' + `${weather_feed_style.bannerContentId}daysFontColor`);
