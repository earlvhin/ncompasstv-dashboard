import { Component, OnInit, Input, Injectable, Output, EventEmitter, ViewChild, ElementRef, Inject, Optional } from '@angular/core';
...
export class PlaylistDemoComponent implements OnInit {
	...
	constructor(private _playlist: PlaylistService, @Optional() @Inject(MAT_DIALOG_DATA) public _dialog_data: any) {}
	...
	playVideo(filetype, i) {
		...
		this.current_content = of(`${this.playlist_content[this.count].file_url}${this.playlist_content[this.count].file_name}`);
