...
export class ExportsTabComponent implements OnInit {
    ...
    hosts_table_column = [
        ...
        { name: 'Last Online', hidden: true, no_show: true, key:'timeIn' },
    ...
    exportHostsTable(tab) {
        ...
        const first_column = [ 'Host ID','Host Name', 'Category', 'Dealer Name', 'License Key', 'Alias', 'Type', 'Last Online', 'Pi Version', 'Installation Date', 'Creation Date', 'Zone & Duration', '', '', '', 'Address', 'City', 'State', 'Postal Code', 'Timezone', 'Tags', 'Total Business Hours'];
    ...
    getDataForExport(tab: string): void {
        ...
        switch (tab) {
            case 'licenses':
                this._license.get_all_licenses_duration_clone(0, '', 'PiStatus', 'desc', 0,  false, '', '', '', '', '', '', '')
