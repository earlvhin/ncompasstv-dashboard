		...
		if (this.search_keyword) {
			this.search_result = this.data_reference.filter(res => {
				if(typeof res[this.primary_keyword] === 'object') {
					if (res[this.primary_keyword].value.toLowerCase().includes(this.search_keyword.toLowerCase()) || 
						res[this.secondary_keyword].value.toLowerCase().includes(this.search_keyword.toLowerCase())) {
						return res;
					} else if(res[this.primary_keyword].value.toLowerCase().includes(this.search_keyword.toLowerCase())) {
						return res;
					}
				} else {
					if (res[this.primary_keyword].toLowerCase().includes(this.search_keyword.toLowerCase()) || 
