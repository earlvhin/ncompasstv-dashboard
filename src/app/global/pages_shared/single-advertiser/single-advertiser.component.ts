...
export class SingleAdvertiserComponent implements OnInit, OnDestroy {
    ...
    ngOnInit() {
        ...
        this._params.queryParams
            ...
            .subscribe((data) => (this.selected_index = data.tab));
    }
    ...
    activity_mapToUI(activity): any {
        ...
        return activity.map((a: any) => {
            ...
            if (activityCode === 'modify_advertiser')
                activityMessage = `${createdBy.firstName} ${createdBy.lastName} modified the advertiser`;
