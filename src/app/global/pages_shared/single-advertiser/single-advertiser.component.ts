...
import { API_ADVERTISER, API_CONTENT, API_DEALER, UI_TABLE_ADVERTISERS_CONTENT } from 'src/app/global/models';
import { AdvertiserService, ContentService, DealerService, HelperService } from 'src/app/global/services';
		...
		return contents.map((content) => {
			return {
				...
				name: {
					...
					link: `/${this.current_role}/media-library/${content.contentId}`,
					new_tab_link: true,
					editable: false,
					hidden: false
				},
