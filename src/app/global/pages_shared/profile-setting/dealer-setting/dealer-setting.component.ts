...
export class DealerSettingComponent implements OnInit, OnDestroy {
    ...
    getUserById(id: string) {
        let isAdmin =
            this._auth.current_role === UI_ROLE_DEFINITION_TEXT.dealeradmin ||
            this._auth.current_role === UI_ROLE_DEFINITION_TEXT.administrator
                ? true
                : false;
        this._user
    ...
    updateDealer() {
        const modifyDealer = new ACTIVITY_LOGS(
            this.user_data.dealerId,
            'modify_dealer_profile',
