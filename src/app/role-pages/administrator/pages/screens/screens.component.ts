...
export class ScreensComponent implements OnInit {
    ...
    getTotalScreens() {
        ...
        this.subscription.add(
            this._screen.get_screen_total().subscribe((data: any) => {
    ...
    screen_mapToUI(data) {
        ...
        return data.map((s) => {
            return new UI_TABLE_SCREEN(
                ...
                {
                    value: this._titlecase.transform(s.screenName),
                    link: '/administrator/screens/' + s.screenId,
                    editable: false,
                    hidden: false,
                    new_tab_link: true,
                },
                {
                    value: s.businessName ? this._titlecase.transform(s.businessName) : '--',
                    link: '/administrator/dealers/' + s.dealerId,
                    editable: false,
                    hidden: false,
                    new_tab_link: true,
                },
                {
                    value: s.hostName != null ? this._titlecase.transform(s.hostName) : '--',
                    link: s.hostName ? '/administrator/hosts/' + s.hostId : null,
                    editable: false,
                    hidden: false,
                    new_tab_link: true,
                },
                ...
                {
                    value: s.templateName != '' ? this._titlecase.transform(s.templateName) : null,
                    link: null,
                    editable: false,
                    hidden: false,
                },
                {
                    value: this._date.transform(s.dateCreated, 'MMM d, y, h:mm a'),
                    link: null,
                    editable: false,
                    hidden: false,
                },
                {
                    value: this._date.transform(s.dateUpdated, 'MMM d, y, h:mm a') || '--',
                    link: null,
                    editable: false,
                    hidden: false,
                },
                {
                    value: s.createdBy ? this._titlecase.transform(s.createdBy) : '--',
                    link: '/administrator/users/' + s.createdById,
                    editable: false,
                    hidden: false,
                    new_tab_link: true,
                },
