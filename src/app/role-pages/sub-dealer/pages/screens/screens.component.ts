    ...
    private mapScreenToUI(data: any[]): UI_DEALER_TABLE_SCREEN[] {
        ...
        return data.map((screen) => {
            return new UI_DEALER_TABLE_SCREEN(
                ...
                {
                    value: screen.hostName ? this._titlecase.transform(screen.hostName) : '--',
                    link: '/sub-dealer/hosts/' + screen.hostId,
                    editable: false,
                    hidden: false,
                },
                ...
                {
                    value: this._date.transform(screen.dateCreated, 'MMM d, y, h:mm a'),
                    link: null,
                    editable: false,
                    hidden: false,
                },
                {
                    value: this._titlecase.transform(screen.createByName),
                    link: null,
                    editable: false,
                    hidden: false,
                },
