...
export class ScreensComponent implements OnInit {
    ...
    getTotalScreens(id) {
        ...
        this.subscription.add(
            this._screen.get_screen_total_by_dealer(id).subscribe((data: any) => {
                this.screen_details = {
                    basis: data.total,
        ...
        return data.map((s) => {
            return new UI_DEALER_TABLE_SCREEN(
                ...
                { value: counter++, link: null, editable: false, hidden: false },
                {
                    ...
                    link: '/dealer/screens/' + s.screenId,
                    editable: false,
                    hidden: false,
                    new_tab_link: true,
                },
                {
                    ...
                    link: '/dealer/hosts/' + s.hostId,
                    editable: false,
                    hidden: false,
                },
                {
                    value: s.hostName ? this._titlecase.transform(s.hostName) : '--',
                    link: '/dealer/hosts/' + s.hostId,
                    editable: false,
                    hidden: false,
                },
                {
                    value: s.templateId ? this._titlecase.transform(s.templateName) : null,
                    link: null,
                    editable: false,
                    hidden: false,
                },
                ...
                {
                    value: this._titlecase.transform(s.createByName),
                    link: null,
                    editable: false,
                    hidden: false,
                },
